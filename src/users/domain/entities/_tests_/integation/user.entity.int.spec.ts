...
describe('User entity integration tests', () => {
  describe('constructor method', () => {
    ...
    it('Should throw an error when creating a user with email', () => {
      let props: UserProps = {
        ...UserDataBuilder({}),
        email: null,
      }
    ...
    it('Should throw an error when creating a user with password', () => {
      let props: UserProps = {
        ...UserDataBuilder({}),
        password: null,
      }
  ...
  describe('update user name', () => {
    it('Should throw an error when update a user with name', () => {
